...
import com.central.common.handler.LogisticsHandler;
...
public class CommonController {
    ...
    @GetMapping("/test")
    public Result<LoginAppUser> test(String platform) {
        LogisticsService service = logisticsHandler.getHandler(platform);
        service.createOrder("");

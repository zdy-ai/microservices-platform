...
public class FeedsApi {
     ...
     */
    public Call cancelFeedAsync(String feedId, final ApiCallback<Void> callback) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public Call getFeedAsync(String feedId, final ApiCallback<Feed> callback) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public Call getFeedDocumentAsync(String feedDocumentId, final ApiCallback<FeedDocument> callback) throws ApiException {

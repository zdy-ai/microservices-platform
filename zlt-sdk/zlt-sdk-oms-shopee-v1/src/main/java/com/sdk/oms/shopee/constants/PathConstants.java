...
public class PathConstants {
    ...
    public static final String ITEM_GET_LIST_RELATIVE_PATH = "/api/v2/product/get_item_list";

    public static final String ITEM_GET_DETAIL_RELATIVE_PATH = "/api/v2/product/get_item_base_info";
    ...
    public static final String ORDER_GET_LIST_RELATIVE_PATH = "/api/v2/order/get_order_list";
    ...
    public static final String ORDER_GET_ORDER_DETAIL_RELATIVE_PATH = "/api/v2/order/get_order_detail";

    public static final String ORDER_GET_BY_STATUS_RELATIVE_PATH = "/api/v2/order/get_order_list";

...
import com.sdk.oms.shopee.api.domain.ItemService;
import com.sdk.oms.shopee.core.service.BaseRestClientService;
import com.sdk.oms.shopee.model.PaginationBaseRequest;
import com.sdk.oms.shopee.model.item.Attribute;
import com.sdk.oms.shopee.model.item.Category;
import com.sdk.oms.shopee.model.item.Category.Categories;
import com.sdk.oms.shopee.model.item.request.*;
import com.sdk.oms.shopee.model.item.response.*;
...
import static com.sdk.oms.shopee.model.item.Attribute.Attributes;
import static com.sdk.oms.shopee.model.item.response.ItemBatchResult.ItemUpdateBatchesResult;
import static com.sdk.oms.shopee.model.item.response.VariationBatchResult.VariationBatchesResult;
...
public class ItemServiceImpl extends BaseRestClientService implements ItemService{
    ...
    public ItemsResult getItemList(PaginationBaseRequest queryRequest) {
        ...
        ItemsResult result = post(ItemsResult.class, uri(ITEM_GET_LIST_RELATIVE_PATH)).entity(queryRequest).executeWithErrorResponse();
        return result;
    }

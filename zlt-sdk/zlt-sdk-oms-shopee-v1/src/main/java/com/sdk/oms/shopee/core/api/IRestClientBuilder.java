package com.sdk.oms.shopee.core.api;
...
public interface IRestClientBuilder<R, T extends IRestClientBuilder<R, T>> {
    ...
    /**
     * The META-INF endpoint to connect to
     *
     * @param endpoint the endpoint URL of the META-INF
     * @return self for method chaining
     */
    T endpoint(String endpoint);

    /**
     * The auth endpoint to connect to, could be different with META-INF endpoint
     *
     * @param endpoint the auth endpoint URL of the META-INF
     * @return self for method chaining
     */
